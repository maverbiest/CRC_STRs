...
def detect_trs(fasta_handle, output_dir, detectors=None, write=True):
    ...
    for record in sequences:
        ...
        denovo_list = custom_detect.detect(
            sequence=seq,
            denovo=True, 
...
def main():
    try:
        ...
        test_path = "/cfs/earth/scratch/verb/projects/CRC_STRs/data/test/fasta/avg_protein_coding_gene.fa"
        test_output = "/cfs/earth/scratch/verb/projects/CRC_STRs/results/test/"
        detectors = ["XSTREAM", "TRF"]
        detect_trs(test_path, test_output, detectors=detectors, write=False)
